...
struct NarrativeView: View {
    ...
    /// 본체는 SourceAnchor로 통합 (#61 PR1) — 기존 호출부·테스트 호환용 위임.
    nonisolated static func jumpSnippet(in body: String, atUTF16 offset: Int) -> String? {
        SourceAnchor.jumpSnippet(in: body, atUTF16: offset)
    }
