> HISTORICAL SNAPSHOT — preserved from main c02c22e on 2026-09-10. Not a current instruction or release commitment. Current contracts: GitHub #99 and the active issue. Read only for a specific historical question.
